...
export const MobileFriendlyScrubber: React.FC<MobileFriendlyScrubberProps> = ({
  ...
  return (
    <div
      ...
      className="w-full neumorph-panel rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 flex items-center gap-1.5 sm:gap-2.5 touch-none select-none"
      onPointerDown={(e) => e.stopPropagation()}
      onTouchStart={(e) => e.stopPropagation()}
    >
      {/* 1. Play / Pause Button with Neumorphic Accent */}
      <button
        type="button"
